<!--Action Button-->
@if( Active::checkUriPattern( 'admin/expensecategories' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.expensecategories.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.expensecategories.all' ) }}
            </a>
        </li>
        @permission( 'create-expensecategory' )
            <li>
                <a href="{{ route( 'admin.expensecategories.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.expensecategories.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
