<!--Action Button-->
@if( Active::checkUriPattern( 'admin/expenses' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.expenses.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.expenses.all' ) }}
            </a>
        </li>
        @permission( 'create-expense' )
            <li>
                <a href="{{ route( 'admin.expenses.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.expenses.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
