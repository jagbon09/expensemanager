...
return [
	...
	"expensecategories" => [
	"already_exists" => "That ExpenseCategory already exists. Please choose a different name.",
	"create_error" => "There was a problem creating this ExpenseCategory. Please try again.",
	"delete_error" => "There was a problem deleting this ExpenseCategory. Please try again.",
	"not_found" => "That ExpenseCategory does not exist.",
	"update_error" => "There was a problem updating this ExpenseCategory. Please try again.",
	],
	],
	"frontend" => [
	"auth" => [
	...
	"resend" => "Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href=http://expenses_manager.loc/account/confirm/resend/:user_id>click here</a> to resend the confirmation e-mail.",
